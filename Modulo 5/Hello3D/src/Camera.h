...
public:
    Vec3  position;
    float yaw;         // angulo horizontal em graus
    float pitch;       // angulo vertical em graus
    ...
    // Move a camera no espaco de visao (forward/strafe/vertical em [-1,1])
    ...
    // Rotaciona a camera com base no deslocamento do mouse em pixels
    ...
    // Retorna a matriz de visao para enviar ao shader
